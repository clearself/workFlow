...
export const get_selested_all_fileds = (data) => {
	return axios.request({
		url: 'api/manage/workMould/getAlarmField',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const get_condition = (data) => {
	return axios.request({
		url: 'api/manage/workMould/allCondition',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const get_work_fileds = (data) => {
    return axios.request({
        url: 'api/manage/workMould/getWorkOrderField',
        method: 'post',
        params: data.queryData,
        data: data.paramsData,
    }).then(result => {
...
export const get_leak_fileds = (data) => {
    return axios.request({
        url: 'api/manage/workMould/getLeakField',
        method: 'post',
        params: data.queryData,
        data: data.paramsData,
    }).then(result => {
