                ...
                <div style="display: flex; padding: 10px 0px; justify-content: space-between;">
                    <div>
                        ...
                        <el-tooltip effect="dark" content="新建" placement="bottom">
                            <el-button type="primary" size="mini" icon="el-icon-circle-plus" @click="newDiagram"/>
                        </el-tooltip>
                        <el-tooltip effect="dark" content="自适应屏幕" placement="bottom">
                            <el-button type="primary" size="mini" icon="el-icon-rank" @click="fitViewport"/>
                        </el-tooltip>
                        <el-tooltip effect="dark" content="放大" placement="bottom">
                            <el-button type="primary" size="mini" icon="el-icon-zoom-in" @click="zoomViewport(true)"/>
                        </el-tooltip>
                        <el-tooltip effect="dark" content="缩小" placement="bottom">
                            <el-button type="primary" size="mini" icon="el-icon-zoom-out" @click="zoomViewport(false)"/>
                        </el-tooltip>
                        <el-tooltip effect="dark" content="预览" placement="bottom">
                            <el-button type="primary" size="mini" icon="el-icon-view" @click="preView"/>
                        </el-tooltip>
                        <el-tooltip effect="dark" content="后退" placement="bottom">
                            <el-button type="primary" size="mini" icon="el-icon-back" @click="handleUndo"/>
                        </el-tooltip>
                        <el-tooltip effect="dark" content="前进" placement="bottom">
                            <el-button type="primary" size="mini" icon="el-icon-right" @click="handleRedo"/>
                        </el-tooltip>
                    </div>
                    <div>
                        <el-button type="primary" size="mini" icon="el-icon-download" @click="saveXML(true)">下载xml</el-button>
                        <el-button type="primary" size="mini" icon="el-icon-picture" @click="saveImg('svg', true)">下载svg</el-button>
